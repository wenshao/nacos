...
public class CatalogServiceV2ImplTest {
    ...
    public void testGetServiceDetail() throws NacosException {
        ...
        JSONObject objectNode = (JSONObject) obj;
        Assert.assertEquals("C", objectNode.getJSONObject(FieldsConstants.SERVICE).getString(FieldsConstants.NAME));
        Assert.assertEquals("B", objectNode.getJSONObject(FieldsConstants.SERVICE).getString(FieldsConstants.GROUP_NAME));
        Assert.assertEquals("none",
                objectNode.getJSONObject(FieldsConstants.SERVICE).getJSONObject(FieldsConstants.SELECTOR).get("type"));
        Assert.assertEquals(0, objectNode.getJSONObject(FieldsConstants.SERVICE).getJSONObject(FieldsConstants.METADATA).size());
        Assert.assertEquals(0.75,
                objectNode.getJSONObject(FieldsConstants.SERVICE).getDouble(FieldsConstants.PROTECT_THRESHOLD), 0.1);
    }
    ...
    public void testPageListService() throws NacosException {
        ...
        JSONObject obj = (JSONObject) catalogServiceV2Impl.pageListService("A", "B", "C", 1, 10, null, false);
        Assert.assertEquals(1, obj.getIntValue(FieldsConstants.COUNT));
    }
    ...
    public void testPageListServiceNotSpecifiedName() throws NacosException {
        ...
        JSONObject obj = (JSONObject) catalogServiceV2Impl.pageListService("A", "", "", 1, 10, null, false);
        Assert.assertEquals(1, obj.getIntValue(FieldsConstants.COUNT));
    }
    ...
    public void testPageListServiceForIgnoreEmptyService() throws NacosException {
        ...
        JSONObject obj = (JSONObject) catalogServiceV2Impl.pageListService("A", "B", "C", 1, 10, null, true);
        Assert.assertEquals(0, obj.getIntValue(FieldsConstants.COUNT));
    }
    ...
    public void testPageListServiceForPage() throws NacosException {
        ...
        JSONObject obj = (JSONObject) catalogServiceV2Impl.pageListService("CatalogService", "", "", 2, 1, null, false);
        Assert.assertEquals(3, obj.getIntValue(FieldsConstants.COUNT));
        Assert.assertEquals("2", obj.getJSONArray(FieldsConstants.SERVICE_LIST).getJSONObject(0).getString("name"));
    }
